...
$(function() {
    ...
    $("#advice a,#feedback").click(function() {
            ...
            adviceBox.removeClass("fadeOutDown").addClass("fadeIndown")
            bg.fadeIn(1000)
            send.click(function() {
                var checkboxVal = "",
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        adviceBox.removeClass("fadeIndown").addClass("fadeOutDown")
                        bg.fadeOut(1000)
                    },
                    error: function() {
    ...
    //去除覆盖的样式
    $(".question1 input").removeClass("labelauty").css('display','inline-block')
