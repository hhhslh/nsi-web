...
$(function() {
    ...
    $.ajax({
        ...
        success :   function(msg) {
            console.log(msg)
            var imgSrc = msg.data.schoolLogo ?  changeUrl.imgAddress + msg.data.schoolLogo : '../assets/img/schoolNoPic.png';
            ...
            if(msg.data.operationstate == "运营中"){
                $('.icon').addClass("operating")
            }else if(msg.data.operationstate == "停办"){
                $('.icon').addClass("close")                               
            }else{
                $('.icon').addClass("preparation")
            }
